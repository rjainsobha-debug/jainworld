              ...
              <div class="space-y-2">
                ...
                <div class="jw-footer-links text-sm text-stone-600">
                  ${group.links
                    .map(
                      (link) => `
                        <a href="${link.href}" class="hover:text-stone-900">${link.label}</a>
                      `
                    )
                    .join("")}
                </div>
      ...
      <div class="jw-overlay-panel">
        <div class="flex items-center justify-between border-b border-stone-200 px-5 py-4">
          <div>
            ...
            <p class="m-0 mt-1 text-sm text-stone-600" id="search-overlay-subtitle">
              Search across literature, education, temples, food, audio, news, blogs, and resources.
            </p>
          </div>
